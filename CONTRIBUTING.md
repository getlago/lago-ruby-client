...
| `beginner`      | [Issues](https://github.com/getlago/lago-ruby-client/labels/%F0%9F%90%A3%20Beginner)       | Less complex issues which would be good first issues to work on for users who want to contribute to Lago.                            |
