...
RSpec.describe Lago::Api::Resources::Customers::Wallet do
  ...
  describe '#create' do
    ...
    context 'when wallet is successfully created' do
      before do
        stub_request(:post, "https://api.getlago.com/api/v1/customers/#{resource_id}/wallets")
          .with(body: body)
  ...
  describe '#update' do
    ...
    context 'when wallet is successfully updated' do
      before do
        stub_request(:put, "https://api.getlago.com/api/v1/customers/#{resource_id}/wallets/#{code}")
          .with(body: body)
          .to_return(body: response, status: 200)
      end

      it 'returns an wallet' do
        wallet = resource.update(params, code)
    ...
    context 'when wallet failed to update' do
      ...
      it 'raises an error' do
        expect { resource.update(params, code) }.to raise_error Lago::Api::HttpError
      end
    end
  end
  ...
  describe '#get' do
    ...
    context 'when wallet is successfully fetched' do
      before do
        stub_request(:get, "https://api.getlago.com/api/v1/customers/#{resource_id}/wallets/#{code}")
          .to_return(body: response, status: 200)
      end

      it 'returns an wallet' do
        wallet = resource.get(code)
    ...
    context 'when there is an issue' do
      ...
      it 'raises an error' do
        expect { resource.get(code) }.to raise_error Lago::Api::HttpError
      end
    end
  end
  ...
  describe '#destroy' do
    ...
    context 'when wallet is successfully terminated' do
      before do
        stub_request(:delete, "https://api.getlago.com/api/v1/customers/#{resource_id}/wallets/#{code}")
          .to_return(body: response, status: 200)
      end

      it 'returns an wallet' do
        wallet = resource.destroy(code)
    ...
    context 'when there is an issue' do
      ...
      it 'raises an error' do
        expect { resource.destroy(code) }.to raise_error Lago::Api::HttpError
      end
    end
  end
